    ...
    return (
      <div className="container">
        ...
        <div className="splashWrap">
          <p className="splashTextTitle">Login</p>
          <p className="splashText">Please enter your username</p>
          <p className="splashText">and password to login.</p>
          <br />
          <form onSubmit={this.onHandleSubmit}>
            <label htmlFor="username" className="red">
              Username{" "}
            </label>
            <input
              type="text"
